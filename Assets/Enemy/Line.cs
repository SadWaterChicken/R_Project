...
public struct Line
{
    ...
    {
        Vector3 lineDir = new Vector3(1, gradient, 0).normalized; // XY instead of XZ
        Vector3 lineCentre = new Vector3(pointOnLine_1.x, pointOnLine_1.y, 0) + Vector3.forward * 0.1f;
